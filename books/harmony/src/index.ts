...
import { attachLegacyCheckpoints } from './legacy-checkpoints.generated';
...
export const harmonyBook: Book = attachLegacyCheckpoints({
  id: harmonyBookId, schemaVersion, contentVersion: '1.3.0', engineVersion: '0.2.0', subject: 'music', title: '화성학', description: '보고, 듣고, 조작하며 이해하는 화성학 교재', language: 'ko-KR',
