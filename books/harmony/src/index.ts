...
export const harmonyBook: Book = {
  id: harmonyBookId, schemaVersion, contentVersion: '0.2.1', engineVersion: '0.1.0', subject: 'music', title: '화성학', description: '보고, 듣고, 조작하며 이해하는 화성학 교재', language: 'ko-KR',
  parts: [{ id: 'harmony.part.pitch', title: 'PART 1. 음', lessons: [{
    ...
    blocks: [
      ...
      { id: 'harmony.block.interval.examples', type: 'activity.subject', objectiveRefs: ['harmony.objective.interval'], dataRefs: ['harmony.data.interval.examples'], data: { subject: 'music', tool: 'pitch-pair-viewer', title: '대표 음정을 비교해 듣기', input: { pairs: [[C4, D4], [C4, { step: 'E', alter: -1, octave: 4 }], [D4, A4]] } } },
    ...
    blocks: [
      ...
      { id: 'harmony.block.triad.examples', type: 'activity.subject', objectiveRefs: ['harmony.objective.triad'], dataRefs: ['harmony.data.triad.examples'], data: { subject: 'music', tool: 'pitch-pair-viewer', title: 'F장3화음과 F단3화음 비교', input: { pairs: [[F4, A4, C5], [F4, { step: 'A', alter: -1, octave: 4 }, C5]] } } },
    ...
    blocks: [
      ...
      { id: 'harmony.block.cadence.listener', type: 'activity.subject', objectiveRefs: ['harmony.objective.cadence'], dataRefs: ['harmony.data.cadence.examples'], data: { subject: 'music', tool: 'cadence-listener', title: '들리는 종지 판별하기', input: { progressions: [], target: 'authentic', hideAnalysisUntilAnswer: true } } },
    ...
    blocks: [
      ...
      { id: 'harmony.block.voice-leading.editor', type: 'activity.subject', objectiveRefs: ['harmony.objective.voice-leading'], data: { subject: 'music', tool: 'voice-leading-editor', title: '반대 방향으로 병행8도 고치기', input: { targetPitch: B4, instruction: '시작음 C5에서 한 단계 아래인 B4로 도착해, 위로 움직이는 베이스와 반대 방향을 만드세요.', value: { id: 'music.voice-leading.parallel-octave', voices: [{ id: 'soprano', name: '소프라노', pitches: [C5, { step: 'D', alter: 0, octave: 5 }] }, { id: 'bass', name: '베이스', pitches: [C4, D4] }] } } } },
