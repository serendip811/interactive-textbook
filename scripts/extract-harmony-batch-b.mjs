...
const outputPath = resolve(root, 'migration/harmony-batch-b-extract.json');
...
if (lessons.length !== 13) throw new Error(`Batch B must contain 13 lessons, found ${lessons.length}`);
mkdirSync(dirname(outputPath), { recursive: true });
writeFileSync(outputPath, `${JSON.stringify({ source: 'Harmony RC1', batch: 'B', parts: [3, 4, 5], lessons }, null, 2)}\n`);
