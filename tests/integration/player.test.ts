...
describe('data-driven player', () => {
  ...
  it('reaches cadence after the final seventh-chord lesson', () => { expect(getLessonNavigation(harmonyBook, 'harmony.lesson.seventh-resolution.lesson').next?.id).toBe('harmony.lesson.cadence'); });
