...
import { validateBook, validateBookIdentity } from '../../engine/schema/src';
...
describe('functions and graphs pilot book', () => {
  ...
  it('passes the deploy-time content contract', () => { expect(validateBook(functionsBook, { supportedBlockTypes: commonBlockKinds })).toEqual([]); });
